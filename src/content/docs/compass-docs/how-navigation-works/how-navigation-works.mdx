...
- `src/pages/[parent]/[category]/[slug].astro` renders canonical article pages
...
## Canonical routes and convenience routes

Compass includes canonical nested article routes like `/getting-started/compass-docs/manage-docs`, plus flatter convenience routes for some pages.

The nested routes are the primary docs structure because they:
